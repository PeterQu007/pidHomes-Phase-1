...
<div class="rh_agent_profile">
	...
	<div class="rh_agent_profile__wrap">
		...
		<div class="rh_agent_profile__head">
            ...
            <a title="<?php the_title(); ?>" href="<?php echo get_site_url() . '/about'; ?>">
              <!-- <?php print_X('red', get_site_url() . '/about', 'agent card'); ?> -->
				...
				<div class="rh_agent_profile__name">
					...
					<div class="rh_agent_profile__social">
						...
						if ( ! empty( $facebook_url ) ) {
							?>
							<a target="_blank" href="<?php echo esc_url( $facebook_url ); ?>"><i class="fab fa-facebook-f"></i></a>
							<?php
						}

						if ( ! empty( $twitter_url ) ) {
							?>
							<a target="_blank" href="<?php echo esc_url( $twitter_url ); ?>"><i class="fab fa-twitter"></i></a>
							<?php
						}

						if ( ! empty( $linked_in_url ) ) {
							?>
							<a target="_blank" href="<?php echo esc_url( $linked_in_url ); ?>"><i class="fab fa-linkedin-in"></i></a>
							<?php
						}

						if ( ! empty( $instagram_url ) ) {
							?>
							<a target="_blank" href="<?php echo esc_url( $instagram_url ); ?>"><i class="fab fa-instagram"></i></a>
							<?php
						}
						?>
					</div>
